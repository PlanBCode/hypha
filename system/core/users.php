...
?>
	function login() {
		...
		html+= '<tr><th><?=__('username')?>:</th><td><input name="loginUsername" id="loginUsername" type="text" size="10" /></td></tr>';
		html+= '<tr><th><?=__('password')?>:</th><td><input name="loginPassword" type="password" size="10" /></td></tr>';
